...
const featuredServices = [
  {
    ...
    description:
      "Asesoría integral en estructuración corporativa, contratos mercantiles y gobierno de sociedades.",
    icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
  },
  {
    title: "Fusiones y Adquisiciones",
    description:
      "Acompañamiento estratégico en operaciones de M&A, due diligence y reestructuras corporativas.",
    icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4",
  },
  {
    title: "Gobierno Corporativo",
    description:
      "Diseño e implementación de estructuras de gobernanza que fortalecen la toma de decisiones.",
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
  },
  {
    title: "NewLaw & Legal Tech",
    description:
      "Innovación jurídica integrando tecnología de vanguardia con pensamiento estratégico legal.",
    icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
  },
  {
    title: "Derecho Laboral",
    description:
      "Soluciones integrales en relaciones laborales, cumplimiento normativo y litigio especializado.",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
  },
  {
    title: "Migratorio",
    description:
      "Gestión de trámites migratorios para empresas y profesionales con presencia internacional.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              ...
              <p className="text-text-light leading-relaxed mb-6">
                Huxley Partners está conformado por profesionales con sólida
              ...
              <p className="text-text-light leading-relaxed mb-8">
                Nuestra visión es construir relaciones duraderas basadas en la
                confianza, ofreciendo certeza jurídica y contribuyendo al
                desarrollo de negocios éticos, innovadores, responsables y
                sostenibles.
              </p>
              <Link
                href="/nuestra-firma"
