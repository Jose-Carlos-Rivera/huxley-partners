...
export const metadata: Metadata = {
  title: "Our Services | Huxley Partners",
  description:
    "Specialized legal services: corporate, mergers and acquisitions, corporate governance, labor, immigration, nearshoring, foreign trade, and more.",
};
