        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-lg text-gray-200 max-w-2xl mx-auto leading-relaxed">
              We are ready to help you. Send us a message and our team will
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-xs text-text-light">
                    I agree to receive electronic communications from Huxley
                    Partners. I can unsubscribe at any time.
                  </label>
                </div>
